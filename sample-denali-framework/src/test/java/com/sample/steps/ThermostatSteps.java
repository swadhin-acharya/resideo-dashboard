...
import com.sample.pages.ThermostatPage;
...
public class ThermostatSteps {
    ...
    private final ThermostatPage thermostatPage = new ThermostatPage(DriverFactory.getDriver());
    ...
    public void confirmSetpoint(int expected) {
        assertThat(targetTemp).isEqualTo(expected);
    ...
    public void verifyMode(String expected) {
        assertThat(currentMode).isEqualTo(expected);
    ...
    public void steadyState() {
        System.out.println("[THERMOSTAT] Steady state");
    }
    ...
    public void reconnects(int seconds) {
        ...
        assertThat(networkConnected).isTrue();
    }
    ...
    public void scheduleRecovered() {
        ...
        assertThat(scheduleRecovered).isTrue();
    }
}
