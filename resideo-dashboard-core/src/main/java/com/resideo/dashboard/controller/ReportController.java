...
import com.resideo.dashboard.service.NotificationService;
import com.resideo.dashboard.service.ReportService;
...
public class ReportController {
    ...
    public ResponseEntity<Map<String, String>> emailReport(
        ...
        String from = body.getOrDefault("from", "noreply@resideodashboard.com");
