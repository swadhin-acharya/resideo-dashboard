package com.resideo.dashboard.cucumber;
 ...
 *   cucumber.plugin=com.resideo.dashboard.cucumber.DashboardCucumberPlugin
 *   resideo.dashboard.url=http://localhost:8080
 *   resideo.dashboard.api-key=optional-secret
 */
public class DashboardCucumberPlugin implements ConcurrentEventListener {

    private static final String DASHBOARD_URL = System.getProperty("resideo.dashboard.url", "http://localhost:8080");
    private static final String API_KEY = System.getProperty("resideo.dashboard.api-key", "");
    private static final String EXECUTION_ID = System.getProperty("resideo.execution.id", "");
    ...
    private void post(String path, Object body) {
        try {
            ...
            System.err.println("[ResideoDashboard] Failed to post to " + path + ": " + e.getMessage());
        }
    }
