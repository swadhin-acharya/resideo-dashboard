package com.openqa.tests.runner;
 ...
 *   mvn test -Dopenqa.execution.id=$(uuidgen) -Dopenqa.dashboard.url=http://localhost:8080
 */
@Suite
@IncludeEngines("cucumber")
@SelectClasspathResource("features")
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, value = "pretty,json:target/cucumber.json")
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.openqa.tests")
